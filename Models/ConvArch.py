...
class ConvArch(ModelCore):
    ...
    def explain_model(self):
        ...
        key_points = """
            ...
            <p>It defines a 5 layers CNN architecture and adds Dropout and Batch Normalization to try to improve on the ConvArch1.</p>
            """
    ...
    def create_model_architecture(self):
        ...
        return nn.Sequential(
                nn.Conv2d(1, 16, kernel_size=(2, 64)),
                nn.BatchNorm2d(16),
                nn.Dropout(p=self.hyper_params['dropout_rate_conv']),
                # We cannot go straight from 2D to 1D I think
                ...
                nn.Flatten(),
                nn.Dropout(p=self.hyper_params['dropout_rate_fc']),
